...
<head>
    ...
    <!-- BS Stepper -->
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/plugins/bs-stepper/css/bs-stepper.min.css">
    <!-- Tempusdominus Bootstrap 4 -->
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    <!-- JQVMap -->
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/plugins/jqvmap/jqvmap.min.css">
    <!-- overlayScrollbars -->
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/plugins/timepicker/bootstrap-timepicker.min.css">
    ...
    <script src="<?php echo URLROOT; ?>/plugins/webcamjs//webcam.min.js"></script>

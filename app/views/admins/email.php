                    ...
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <div style="color:#999999;font-family:Open Sans, Arial, sans-serif;font-size:15px;line-height:22px;text-align:center;">
                          You have been invited to participate in the upcoming
                          <strong>
                            {ELECTION_TITLE}.
                          </strong>
                          Attached below are credentials that you can use to access the voting platform on election day.
                          <br />
                          <u>
                            <em>
                              VOTE WISELY CTU-NIAN
                              <br />
                              <br />
                            </em>
                          </u>
                          <strong>Voters ID: <em>{VOTER_ID}</em></strong>
                          <br />
                          <strong>Password: <em>{PASSWORD}</em></strong>
                          <br />
                          Please refrain from sharing your personal access codes to anyone.
                        </div>
                      </td>
                    </tr>
                  </table>
                                ...
                                <td style="padding:10px;vertical-align:top;">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%">
                                    ...
                                    <tr>
                                      <td align="center" style="font-size:0px;padding:5px;word-break:break-word;">
                                        <div style="color:#848789;font-family:Open Sans, Arial, sans-serif;font-size:12px;line-height:18px;text-align:center;text-transform:uppercase;">
                                          &copy; 2021 VOTENEST. All Rights Reserved.
                                        </div>
                                      </td>
                                    </tr>
                                    <tr>

        ...
        <div class="container-fluid">
          ...
          <h1 class="page-header text-center title"><b><?php echo strtoupper($title); ?></b></h1>
            <div class="col-md-12 col-md-offset-1">
              <?php flash('submit_error'); ?>
                <!-- Voting Ballot -->
                <form method="POST" id="ballotForm" action="<?php echo URLROOT; ?>/voters/mobilevote" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-md-3">
                    <!-- Profile Image -->
                      ...
                      <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                          ...
                          <li class="list-group-item">
                            ...
                            <button type="button" id="sendi" class="btn btn-primary btn-block"><i class="fa fa-file-text"></i> Submit</button>
                        </ul>
                      </div>
                      <!-- /.card-body -->
                    </div>
                  ...
                  <div class="col-md-9">
                    <div class="tab-content">
                     ...
                     <?php require APPROOT . '/views/inc/voter/mobile_cam.php'; ?>
                </form>
                <!-- End Voting Ballot -->
            </div>
        </div>
